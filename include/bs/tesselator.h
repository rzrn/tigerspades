...
void tesselator_set_color(Tesselator *, RGBA4i);
void tesselator_set_normal(Tesselator *, int8_t x, int8_t y, int8_t z);
void tesselator_addi(Tesselator *, int16_t * coords, RGBA4i *, int8_t * normals);
void tesselator_addf(Tesselator *, float * coords, RGBA4i *, int8_t * normals);
